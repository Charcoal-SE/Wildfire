...
class FlagsControllerTest < ActionController::TestCase
  ...
  test "should create flag" do
    assert_difference('Flag.count') do
      post :create, flag: { attempted_at: @flag.attempted_at, completed: @flag.completed, failure_reason: @flag.failure_reason, id: @flag.id }
    end
  ...
  test "should update flag" do
    patch :update, id: @flag, flag: { attempted_at: @flag.attempted_at, completed: @flag.completed, failure_reason: @flag.failure_reason, id: @flag.id }
    assert_redirected_to flag_path(assigns(:flag))
  end
